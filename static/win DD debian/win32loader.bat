...
set download=0
set try_download=1
set URL=http://depot.treesky.link/windddebian/WindowsSoftware
...
:Yourself
echo.
echo if 'initrd.img' URL is 'http://depot.treesky.link/windddebian/initrd.img', 
echo Please input 'http://mirrors.aliyun.com/debian/'.
...
goto Download
:MoeClub
set IMG_URL=http://mirrors.aliyun.com/debian/
set INITRD_SHA1=47A92FEC2DC85D016C8DDC37585A2AFA778F323F
